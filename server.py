...
import json
import subprocess
from main import create_pi_grid, generate_latex, generate_json_data, calculate_grid_dimensions
...
def generate_latex_endpoint():
    ...
    latex_code = generate_latex(grid_digits, grid_scripts, rows, cols, title, pi_mask)
